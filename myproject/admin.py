...
class ClassAdmin(admin.ModelAdmin):
    list_display = ['program', 'subject', 'year_level', 'section', 'instructor', 'get_student_count']
    list_filter = ['instructor', 'year_level', 'section']
    search_fields = ['program', 'subject', 'year_level', 'section']
